    ...
    <div class="container my-4">
        <div class="relative">
            ...
            <div id="form-container" class="form-container">
                <h2 id="form-title" class="form-title">{{ __('Olvidé mi Contraseña') }}</h2>
                
                <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
                    {{ __('¿Olvidaste tu contraseña? No hay problema. Simplemente déjanos saber tu dirección de correo electrónico y te enviaremos un enlace para restablecer tu contraseña.') }}
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="input-field mt-1" type="email" name="email" :value="old('email')" required autofocus />
